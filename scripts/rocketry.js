...
function expand1() {
	document.getElementById('boxtitle1').innerHTML = "Binary Errors (click to hide)"
	document.getElementById('maths1').style.height = "auto"
}

//function to shrink box to title bar only
function hide1() {
	document.getElementById('boxtitle1').innerHTML = "Binary Errors (click to expand)"
...
//function to expand box to full length
function expand2() {
	document.getElementById('boxtitle2').innerHTML = "Derivation (click to hide)"
	document.getElementById('maths2').style.height = "auto"
}

//function to shrink box to title bar only
function hide2() {
	document.getElementById('boxtitle2').innerHTML = "Derivation (click to expand)"

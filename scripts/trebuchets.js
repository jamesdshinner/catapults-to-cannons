...
function expand1() {
	document.getElementById('boxtitle1').innerHTML = "Lagrangian Mechanics (click to hide)"
	document.getElementById('maths1').style.height = "auto"
}

//function to shrink box to title bar only
function hide1() {
	document.getElementById('boxtitle1').innerHTML = "Lagrangian Mechanics (click to expand)"
